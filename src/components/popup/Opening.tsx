...
export default function Opening({ setStart, namaTamu }: Props) {
  return (
    ...
    >
      ...
      {/* Desktop BG */}
      <div className="absolute inset-0 hidden lg:block bg-[#6B0E0E]">
        {" "}
        <Image
      ...
      <div className="lg:hidden">
        <Image
          src="/images/Wishes/BungaAtas.svg"
          alt=""
          width={390}
          height={300}
        ...
        />
        <Image
          src="/images/Wishes/BungaKanan.svg"
          alt=""
          width={390}
          height={300}
        ...
        />
        <Image
          src="/images/Wishes/BungaKiri.svg"
          alt=""
          width={390}
          height={300}
      ...
      <div className="relative z-20 text-center text-white px-6">
        ...
        <h2 className="font-cylburn text-[46px] lg:text-[64px] mt-[16px] lg:mt-[34px]">
          {namaTamu}
        </h2>
        ...
        <h2 className="font-cylburn text-[32px] lg:text-[48px] mt-[28px] lg:mt-[38px] ">
          you've got mail!
        </h2>
