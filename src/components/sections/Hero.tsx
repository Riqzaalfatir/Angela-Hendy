...
export default function HeroSection() {
  ...
  if (scale === null) return <div style={{ height: `${CANVAS_HEIGHT}px` }} />;
    ...
    >
      ...
      >
        ...
        {/* <Image
          ...
          width={189}
          height={235}
          className="absolute z-50 hero-aset-4"
...
/>
        ...
        <div
          ...
          style={{ top: 250, left: 170, width: 189, height: 235 }}
        >
          ...
          <p className="font-garamond text-black leading-snug mt-[8px] text-[11px]">
            We are delighted to
            <br />
            welcome you to our
            <br />
          ...
          <p className="font-garamond text-black leading-snug mt-2 text-[11px]">
            Here, you'll find all the
            <br />
            essential details for the
            <br />
            wedding
          </p>
        </div>
        ...
        <Image
          ...
          width={107}
          height={311}
          className="absolute z-40 hero-aset-6"
          style={{ top: 149, left: 253, clipPath: "inset(0 50% 0 0)" }}
        />
        ...
        <Image
          ...
          width={279}
          height={302}
          className="absolute z-20 hero-aset-1"
        ...
        <Image
          priority
          src="/images/Hero/PengantinCeweHD.png"
          alt="Foto pengantin wanita"
          width={110}
          height={103}
          className="absolute z-30 hero-aset-2"
          style={{ top: 140, left: 93 }}
        />
        ...
        <Image
          ...
          height={107}
          className="absolute z-30 hero-aset-2"
          style={{ top: 139, left: 92 }}
        />

        {/* Foto pengantin pria */}
        <Image
          priority
          src="/images/Hero/PengantinCowoHD.png"
          alt="Foto pengantin pria"
          width={90}
          height={90}
          className="absolute z-[35] hero-aset-2"
          style={{ top: 155, left: 184 }}
        />
        ...
        <Image
          ...
          width={275}
          height={186}
          className="absolute z-[37] hero-aset-3"
          style={{ top: 165, left: 55 }}
        />
        ...
        <Image
          ...
          width={280}
          height={280}
          className="absolute z-30 hero-aset-7"
        ...
        >
          <p className="font-garamond text-[#7C1419] leading-snug text-[11px]">
            So they no onger two,
            <br />
            but one flesh.
          </p>
          <p className="font-garamond text-[#7C1419] leading-snug text-[11px] mt-1">
            Therefore what God
            <br />
            has joined together, <br /> let no one separate
          </p>
          <p className="font-garamond text-[#7C1419] italic text-[11px] mt-[0.5px] pl-[64px]">
            Matthew 19:6
          </p>
        </div>
        ...
        <Image
          ...
          width={180}
          height={175}
          className="absolute z-50 hero-aset-5"
          style={{ top: 278, left: 41 }}
        />
        ...
        <Image
          ...
          width={107}
          height={311}
          className="absolute z-[90] hero-aset-6"
          style={{ top: 149, left: 252, clipPath: "inset(0 0 0 50%)" }}
        />

        {/* Teks orang tua */}
        <div
          className="hero-aset-8 absolute w-full text-center px-4 z-50"
          style={{ top: 670 }}
        >
          <p className="font-garamond text-[16px] text-white">
            By the Grace of God
          </p>
          ...
          <p className="font-garamond text-[16px] text-white italic mt-[26px]">
            together with
          </p>
          <p className="font-garamond text-[16px] text-white mt-[26px]">
