...
export default function WeddingGift({ open, onClose, onOpenWishes }: Props) {
  ...
  // Salin nomor rekening ke clipboard — tombol COPY
  const handleCopy = () => {
    navigator.clipboard.writeText("8090598253");
    setCopied(true);
    setTimeout(() => setCopied(false), 2000); // reset label setelah 2 detik
  };

  // Scale canvas menyesuaikan lebar layar
  useEffect(() => {
    const updateScale = () => {
  ...
  return (
    <div style={{ display: open ? "block" : "none" }}>
      <div className="gift-overlay" onClick={onClose}>
        ...
        {/* Wrapper konten — stopPropagation agar klik dalam tidak menutup overlay */}
        <div
        ...
        >
          ...
          >
            ...
            {/* Info rekening bank + tombol copy */}
            <div className="absolute z-20"
              ...
              <div className="flex justify-between items-center text-white">
                ...
                {/* Label berubah jadi "COPIED !" setelah diklik */}
                <button
                  onClick={handleCopy}
