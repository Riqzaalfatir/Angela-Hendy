...
// //   return (
// //     <>
// //       <div id="rsvp" className="relative w-full overflow-visible">
...
// //           width={213}
// //           height={213}
// //           className="absolute z-0 bottom-0 right-0 pointer-events-none"
// //           style={{ right: -10 }}
// //         />

// //         {/* Konten utama — flex column */}
// //         <div className="relative z-10 flex flex-col items-center w-full pt-4 pb-20">

// //           {/* Judul "Rsvp" */}
// //           <FadeIn delay={0}>
// //             <p
// //               className="text-center text-white font-cylburn"
// //               style={{ fontSize: 96, lineHeight: "96px", paddingTop: 18 }}
// //             >
// //               Rsvp
// //             </p>
// //           </FadeIn>
...
// //           <FadeIn delay={0.2}>
// //             <p
// //               className="text-center text-white font-garamond mt-8"
...
// //           <FadeIn delay={0.6}>
// //             <p
// //               className="text-center text-white font-cylburn mt-4"
// //               style={{ fontSize: 46, lineHeight: "46px", paddingTop: 18 }}
// //             >
// //               Sela
// //             </p>
// //           </FadeIn>
...
// //               style={{ fontFamily: "EB Garamond, serif", fontSize: 14, lineHeight: "20px" }}
// //             >
...
// //           <div className="flex items-center justify-center gap-[19px] mt-6">
// //             <FadeLeft delay={0.5}>
// //               <button
...
// //               className="bg-white hover:bg-gray-100 transition-colors duration-200 mt-6"
// //               style={{
// //                 width: 222,
// //                 height: 33,
// //                 fontFamily: "EB Garamond, serif",
...
// //               style={{ fontFamily: "EB Garamond, serif", fontSize: 12, lineHeight: "18px" }}
// //             >
...
// //               className="flex items-center justify-center gap-[8px] bg-[#12877B] hover:bg-[#0F6B61] rounded-full text-white mt-6"
...
// //               className="text-center z-20 cursor-pointer mt-28"
// //               style={{
